...
export const SpotifyConnect = () => {
  return (
    <a
      className="bg-green-800 hover:bg-green-500 text-white font-bangers py-2 px-4 border border-black rounded mt-3 mb-3 shadow-md shadow-green-300 animate-bounce"
      href={AUTH_URL}
    >
      Connect to Spotify
    </a>
